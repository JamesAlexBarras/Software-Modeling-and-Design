...
public class MainApp {
    public static void main(String[] args) {
        ...
        if (prod != null)
            System.out.pri`ntln("Product with ID = " + prod.productID + " name = " + prod.name + " price = " + prod.price + " quantity = " + prod.quantity);
        ...
        StoreManager.getInstance().getMainManu().setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        StoreManager.getInstance().getMainManu().setVisible(true); // Show the ProductView!
    }
}
